<div>
    <div class="d-flex justify-content-between align-items-baseline">
        <input wire:model="tablesearch" type="search" name="tablesearch"
               class="form-control bg-white border-0 small w-50" placeholder="Search for...">
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <th>Photo_id</th>
            <th>
                <button wire:click="sortBy('name')" class="d-flex align-items-center border-0 bg-transparant p-0"
                        style="color:#858796;font-weight:bold;">
                    <p class="m-0">Name</p>
