    ...
    <table class="table table-striped shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        ...
        @foreach($boxes as $box)
            <tr>
                ...
                <td>{{$box->deleted_at ? $box->deleted_at->diffForHumans() : ''}}</td>
                <td>
                    <div class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown{{ $box->id }}" role="button"
                        ...
                        <div class="dropdown-menu  shadow "
                             aria-labelledby="userDropdown{{ $box->id }}">
                            @if($box->deleted_at == null)
                            <a class="dropdown-item" href="{{route('boxes.show', $box->slug)}}">
                            ...
                            <a class="dropdown-item" href="{{route('boxes.edit', $box->slug)}}">
                            ...
                            @endif
                            @if($box->deleted_at != null)
                                <form action="{{ route('admin.boxrestore', $box->id) }}" method="POST">
                                    @csrf
                                    @method('POST')
